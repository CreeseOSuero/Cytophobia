...
public class Group4Map1 implements KeyListener{
    static JFrame frame;
    ...
    public Group4Map1(){
        ...
        alphaGrad = new JLabel(setupImage("assets4/alpha_grad.png", mW, 5)) ;
        ...
        pconup_1 = setupImage("assets4/pconup_1.PNG");
        pconup_2 = setupImage("assets4/pconup_2.PNG");
        pcondown_0 = setupImage("assets4/pcondown_0.PNG");
        pcondown_1 = setupImage("assets4/pcondown_1.PNG");
        pcondown_2 = setupImage("assets4/pcondown_2.PNG");
        pconleft_0 = setupImage("assets4/pconleft_0.PNG");
        pconleft_1 = setupImage("assets4/pconleft_1.PNG");
        pconleft_2 = setupImage("assets4/pconleft_2.PNG");
        pconright_0 = setupImage("assets4/pconright_0.PNG");
        pconright_1 = setupImage("assets4/pconright_1.PNG");
        pconright_2 = setupImage("assets4/pconright_2.PNG");
